    ...
    return (
      ...
      <div className="o-container o-container--main">
        <div className="o-grid">  
          <div className="o-grid__one">
            <h2 data-animate> Web developer, audio engineer, musician, creative type.</h2>
          </div> 
        </div>
      </div>
      ...
      <section className="o-container o-container--section">
        <div className="o-paragraph">
          <p>Web Developer at <a target="_blank" href="https://apostrophecms.com">Apostrophe Technologies</a> July 2019 - October 2020, Philadelphia PA.</p>
        ...
        <div className="o-paragraph">
          <p>Web Developer at <a target="_blank" href="https://punkave.com">P'unk Avenue</a> May 2016 - June 2019, Philadelphia PA.</p>
          <p>Built various web tools and custom websites within the art, educational, and non-profit sectors. Managed projects, included client and stakeholder communication, through development, content creation, deployment & support. Select clients included Design Advocacy Group, Covenant House PA, Trenton250, Georgetown University. </p>
        </div>
        <div className="o-paragraph">
          <p>Full Stack Instructional Associate at <a target="_blank" href="https://generalassemb.ly">General Assembly</a> August 2015 - December 2019, Philadelphia PA.</p>
